		...
		<div class="row">
			<div class="col-md-12">
				<div class="mb-3 card">
					...
					<div class="card-body">
						<?= form_open_multipart('administrator/insertwrite'); ?>
						<div class="form-group infomartion">
							<input name="post" value="post" hidden>
						...
						<div class="form-group infomartion">
							<input type="text" class="form-control" id="name" name="title" placeholder="Masukan Judul Informasi">
